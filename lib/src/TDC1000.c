...
void TDC1000_Init(void){
	...
	GPIOB->MODER|=(GPIO_MODE_OUTPUT<<(0<<1));
	GPIOB->BSRR|=(1<<0);
	...
	TDC1000_SPIWrite(TDC1000_REG_ADR_CONFIG_1, TDC1000_REG_CONFIG1_DEFAULTS | (0x7<<TDC1000_REG_CONFIG_1_NUM_RX_Pos) | (0<<TDC1000_REG_CONFIG_1_NUM_AVG_Pos));
	...
	TDC1000_SPIWrite(TDC1000_REG_ADR_CONFIG_3, (0x6<<TDC1000_REG_CONFIG_3_ECHO_QUAL_THLD_Pos) | (0<<TDC1000_REG_CONFIG_3_BLANKING_Pos)\
	...
	TDC1000_SPIWrite(TDC1000_REG_ADR_TIMEOUT, TDC1000_REG_TIMEOUT_DEFAULTS | (0<<TDC1000_REG_TIMEOUT_FORCE_SHORT_TOF_Pos)\
													| (0x1<<TDC1000_REG_TIMEOUT_TOF_TIMEOUT_CTRL_Pos) | (0<<TDC1000_REG_TIMEOUT_ECHO_TIMEOUT_Pos));
	
	TDC1000_SPIWrite(TDC1000_REG_ADR_CLOCK_RATE, (3<<TDC1000_REG_AUTOZERO_PERIOD_Pos) | (0<<TDC1000_REG_CLOCKIN_DIV_Pos));  // AUTOZERO_PERIOD = 4 ???


	uint16_t timreg=1000;
	TDC1000_SPIWrite(TDC1000_REG_ADR_TOF_0, ((timreg&0xFF)<<TDC1000_REG_TOF_0_TIMING_REG_Pos));
	TDC1000_SPIWrite(TDC1000_REG_ADR_TOF_1, (((timreg>>8)&0b11)<<TDC1000_REG_TOF_1_TIMING_REG_Pos) | (0x4<<TDC1000_REG_TOF_1_PGA_GAIN_Pos) | (0x1<<TDC1000_REG_TOF_1_LNA_FB_Pos));
}
...
//	TDC7200_SPIWrite(TDC7200_REG_ADR_CALIBRATION2, ((0b01<<TDC7200_REG_CONFIG2_CALIBRATION2_PERIODS_Pos)\
//																	| (0b000<<TDC7200_REG_CONFIG2_AVG_CYCLES_Pos) | (0b000<<TDC7200_REG_CONFIG2_NUM_STOP_Pos)));
//	
//	TDC7200_SPIWrite(TDC7200_REG_ADR_INT_MASK, ((0b0<<TDC7200_REG_INT_MASK_CLOCK_CNTR_OVF_MASK_Pos)\
//																	| (0b0<<TDC7200_REG_INT_MASK_COARSE_CNTR_OVF_MASK_Pos) | (0b1<<TDC7200_REG_INT_MASK_NEW_MEAS_MASK_Pos)));
}
