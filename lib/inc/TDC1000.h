...
#define TDC7200_REG_CONFIG1_START_MEAS_Pos                (0x00u)
#define TDC7200_REG_CONFIG1_START_MEAS_Msk                (0b1u)
#define TDC7200_REG_CONFIG1_MEAS_MODE_Pos                 (0x01u)
#define TDC7200_REG_CONFIG1_MEAS_MODE_Msk                 (0b11u)
#define TDC7200_REG_CONFIG1_START_EDGE_Pos                (0x03u)
#define TDC7200_REG_CONFIG1_START_EDGE_Msk                (0b1u)
#define TDC7200_REG_CONFIG1_STOP_EDGE_Pos                 (0x04u)
#define TDC7200_REG_CONFIG1_STOP_EDGE_Msk                 (0b1u)
#define TDC7200_REG_CONFIG1_TRIGG_EDGE_Pos                (0x05u)
#define TDC7200_REG_CONFIG1_TRIGG_EDGE_Msk                (0b1u)
#define TDC7200_REG_CONFIG1_PARITY_EN_Pos                 (0x06u)
#define TDC7200_REG_CONFIG1_PARITY_EN_Msk                 (0b1u)
#define TDC7200_REG_CONFIG1_FORCE_CAL_Pos                 (0x07u)
#define TDC7200_REG_CONFIG1_FORCE_CAL_Msk                 (0b1u)

#define TDC7200_REG_CONFIG2_NUM_STOP_Pos                	(0x00u)
#define TDC7200_REG_CONFIG2_NUM_STOP_Msk                	(0b111u)
#define TDC7200_REG_CONFIG2_AVG_CYCLES_Pos                (0x03u)
#define TDC7200_REG_CONFIG2_AVG_CYCLES_Msk                (0b111u)
#define TDC7200_REG_CONFIG2_CALIBRATION2_PERIODS_Pos      (0x06u)
#define TDC7200_REG_CONFIG2_CALIBRATION2_PERIODS_Msk      (0b11u)

#define TDC7200_REG_INT_STATUS_NEW_MEAS_INT_Pos           (0x00u)
#define TDC7200_REG_INT_STATUS_NEW_MEAS_INT_Msk           (0b1u)
#define TDC7200_REG_INT_STATUS_COARSE_CNTR_OVF_INT_Pos    (0x01u)
#define TDC7200_REG_INT_STATUS_COARSE_CNTR_OVF_INT_Msk    (0b1u)
#define TDC7200_REG_INT_STATUS_CLOCK_CNTR_OVF_INT_Pos     (0x02u)
#define TDC7200_REG_INT_STATUS_CLOCK_CNTR_OVF_INT_Msk     (0b1u)
#define TDC7200_REG_INT_STATUS_MEAS_STARTED_FLAG_Pos      (0x03u)
#define TDC7200_REG_INT_STATUS_MEAS_STARTED_FLAG_Msk      (0b1u)
#define TDC7200_REG_INT_STATUS_MEAS_COMPLETE_FLAG_Pos     (0x04u)
#define TDC7200_REG_INT_STATUS_MEAS_COMPLETE_FLAG_Msk     (0b1u)

#define TDC7200_REG_INT_MASK_NEW_MEAS_MASK_Pos           	(0x00u)
#define TDC7200_REG_INT_MASK_NEW_MEAS_MASK_Msk           	(0b1u)
#define TDC7200_REG_INT_MASK_COARSE_CNTR_OVF_MASK_Pos     (0x01u)
#define TDC7200_REG_INT_MASK_COARSE_CNTR_OVF_MASK_Msk     (0b1u)
#define TDC7200_REG_INT_MASK_CLOCK_CNTR_OVF_MASK_Pos      (0x02u)
#define TDC7200_REG_INT_MASK_CLOCK_CNTR_OVF_MASK_Msk      (0b1u)
